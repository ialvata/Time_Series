...
from preprocessing.feature_engineering.ewma import EWMAFeature
...
feat_eng.add_to_pipeline(
    features = [
        ...
        # ),
        EWMAFeature(columns=["value"], alphas=[0.5, 1])
    ]
)
feat_eng.set_datasets(train_set,test_set)
feat_eng.create_features(destiny_set="test")
feat_eng.test_set.dataframe # has 1 row, which was the size of the original test_set
print("OLA")